...
<div class="min-h-screen bg-gray-50/50">
  ...
  <aside class="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 my-0 ml-0 h-[calc(100vh-32px)] w-72 rounded-tr-xl rounded-br-xl transition-transform duration-300 xl:translate-x-0">
    <div class="relative border-b border-white/20">
      <a class="flex items-center gap-4 py-6 px-8" href="#/">
        <h6 onClick={closeDrawer} class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">Material Tailwind Dashboard</h6>
      </a>
  ...
  <div class={`p-4 ${open? "xl:ml-80 lg:ml-80 sm:ml-80" :"ml-5"}`}>

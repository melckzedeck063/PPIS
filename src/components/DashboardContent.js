                  ...
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                     <div class="flex items-center justify-between mb-4">
                        <div class="flex-shrink-0">
                           ...
                           <h3 class="text-base font-normal text-gray-500">Concerns this week</h3>
                        </div>
                     ...
                     <div id="main-char" style={{ width: '100%', height: '600px' }}>
                        <ResponsiveContainer width="100%" height="100%">
                           ...
                           >
                              ...
                              <Tooltip />
                              <Legend />
                              <Bar dataKey="Water" fill="black" activeBar={<Rectangle fill="pink" stroke="blue" />} />
                              <Bar dataKey="Electricity" background="linear-gradient(90deg, red,blue)" fill="var(--org2)" activeBar={<Rectangle fill="gold" stroke="purple" />} />
                              <Bar dataKey="Education" fill="purple" activeBar={<Rectangle fill="gold" stroke="purple" />} />
                              <Bar dataKey="Health" fill="var(--grn)" activeBar={<Rectangle fill="gold" stroke="purple" />} />
                           </BarChart>
                        </ResponsiveContainer>
                     </div>
                  </div>
                                    ...
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-cyan-600 h-2 rounded-sm w-4/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-orange-300 h-2 rounded-sm w-3/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-teal-400 h-2 rounded-sm w-2/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-pink-600 h-2 rounded-sm w-2/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-indigo-600 h-2 rounded-sm w-1/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 align-middle text-xs whitespace-nowrap p-4 pb-0">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-purple-500 h-2 rounded-sm w-1/12"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>

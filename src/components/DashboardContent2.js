           ...
           <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6">
                ...
                <div id="stats" class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow-lg p-6 rounded-lg">
                        <div class="flex flex-row space-x-4 items-center">
                            ...
                            <div>
                                <p class="text-blue-300 text-sm font-bold uppercase leading-4">Invoices</p>
                                <p class="text-blue-600 font-bold text-2xl inline-flex items-center space-x-2">
                                    <span>+79</span>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div id="last-incomes">
                ...
                <div id="stats" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div class="bg-white shadow-lg to-white/5 rounded-lg">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="p-2">
                                    <p class="text-xl font-bold text-blue-600 shadow-lg">348$</p>
                                    <p class="text-blue-600 font-bold ">Land Conflicts</p>
                                    <p class="text-blue-600 font-bold text-sm">24 Concerns</p>
                                </div>
                            </div>
                    ...
                    <div class="bg-white shadow-lg to-white/5 rounded-lg">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="p-2">
                                    <p class="text-xl font-bold text-blue-700">348$</p>
                                    <p class="text-blue-600 font-bold ">Land Conflicts</p>
                                    <p class="text-blue-600 font-bold text-sm">24 Concerns</p>
                                </div>
                            </div>
                            <div class="border-t border-white/5 p-4">
                                <button className='bg-white py-0.5 font-bold rounded-md px-3 text-blue-700'>View All</button>
                            </div>
                    </div>
